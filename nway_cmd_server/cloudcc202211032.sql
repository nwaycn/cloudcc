...
--
-- Name: DATABASE cloudcc; Type: COMMENT; Schema: -; Owner: postgres
--

COMMENT ON DATABASE cloudcc IS '分布式FreeSWITCH配置数据库';
...
--
-- Name: COLUMN nway_acl.default_type; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.nway_acl.default_type IS 'allow or deny';
...
--
-- Name: COLUMN nway_acl_detail.acl_type; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.nway_acl_detail.acl_type IS 'allow or deny';


--
-- Name: COLUMN nway_acl_detail.is_domain; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.nway_acl_detail.is_domain IS 'domain or cidr';


--
-- Name: COLUMN nway_acl_detail.acl_value; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.nway_acl_detail.acl_value IS 'domain or ip/mask';
...
1	admin	945c65b120a8e09f1fa507128e9ba48b	szFswPLYXE	0	2022-03-30 17:56:03.831837	2022-10-19 09:07:41.069472	2022-03-30 17:56:03.831837	lihao@nway.com.cn	47.1-4.124.127	0
\.
...
SELECT pg_catalog.setval('public.nway_fs_node_global_details_id_seq', 93, true);
...
SELECT pg_catalog.setval('public.nway_fs_node_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.nway_fs_profile_details_id_seq', 1279, true);
...
SELECT pg_catalog.setval('public.nway_fs_profiles_id_seq', 10, true);
